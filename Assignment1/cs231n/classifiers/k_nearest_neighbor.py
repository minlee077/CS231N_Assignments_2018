...
class KNearestNeighbor(object):
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in range(num_test):
      ...
      #########################################################################
      kSets=dists[i].argsort()[:k] #argsort를 통해 dists가 낮은 k개의 tarin data를 extract
      closest_y.append(self.y_train[kSets]) #추출한 train data에 대한 label을 추출하여, closest_y에 append
      #########################################################################
      # TODO:                                                                 #
